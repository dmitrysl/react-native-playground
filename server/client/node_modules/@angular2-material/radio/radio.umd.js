(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@angular2-material/core')) :
    typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/forms', '@angular2-material/core'], factory) :
    (factory((global.md = global.md || {}, global.md.radio = global.md.radio || {}),global.ng.core,global.ng.forms,global.md.core));
}(this, (function (exports,_angular_core,_angular_forms,_angular2Material_core) { 'use strict';
...
var MdRadioButton = (function () {
    ...
    MdRadioButton = __decorate([
        ...
        __metadata('design:paramtypes', [MdRadioGroup, _angular2Material_core.MdUniqueSelectionDispatcher])
    ], MdRadioButton);
